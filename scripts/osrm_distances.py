...
np.savetxt("data/inputs/cleaned/HTM_data_collapsed_all_distances_osrm.txt", distances)
np.savetxt("data/inputs/cleaned/HTM_data_collapsed_all_travel_times_osrm.txt", durations)