...
plt.plot(iterations, temps_smooth, color="#D81B60")
...
# Save
plt.tight_layout()
plt.savefig("Figures/Figure_SAtemperatures_final.png", dpi=300)
...
axes[0].plot(iterations, temps_smooth, color="#D81B60")
...
ax1.plot(iterations, temps_smooth, color="#D81B60", label="Temperature")
...
# ---- Plot 1: Total shift length ----
axes[0,0].hist(sa["totalLength"], bins=20, alpha=0.5, label="VND",  color = "#D81B60", density = True)
axes[0,0].hist(bal["totalLength"], bins=20, alpha=0.5, label="Balanced", color = "#1E88E5", density = True)
axes[0,0].set_title("Shift length distribution")
axes[0,0].set_ylabel("Density")
axes[0,0].legend()

# ---- Plot 2: Cleaning time ----
axes[0,1].hist(sa["totalCleaning"], bins=20, alpha=0.5, label="VND",  color = "#D81B60", density = True)
axes[0,1].hist(bal["totalCleaning"], bins=20, alpha=0.5, label="Balanced",  color = "#1E88E5", density = True)
axes[0,1].set_title("Cleaning time distribution")
axes[0,1].set_ylabel("Density")
axes[0,1].legend()

# ---- Plot 1: Total shift length ----
axes[1,0].hist(init["totalLength"], bins=20, alpha=0.5, label="HTM", color = "#FFC107", density = True)
axes[1,0].hist(bal["totalLength"], bins=20, alpha=0.5, label="Balanced", color = "#1E88E5", density = True)
axes[1,0].set_xlabel("Hours")
axes[1,0].set_ylabel("Density")
axes[1,0].legend()

# ---- Plot 2: Cleaning time ----
axes[1,1].hist(init["totalCleaning"], bins=20, alpha=0.5, label="HTM", color = "#FFC107", density = True)
axes[1,1].hist(bal["totalCleaning"], bins=20, alpha=0.5, label="Balanced",  color = "#1E88E5", density = True)
...
# Layout + save
plt.tight_layout()
plt.savefig("Figures/Figure_distribution_all_finalversion_4x4.png", dpi=300)
