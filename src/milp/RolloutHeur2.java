...
public class RolloutHeur2 implements RCESPP {
    ...
    public RolloutHeur2(int runs, int rolloutCandidatePool, int baseCandidatePool, long seed) {
        this.runs = runs;
    ...
    private RouteCandidate rolloutSingle(
        ...
        while (true) {
            ...
            if (closeTotal >= minDuration - 1e-9 &&
                ...
                if (rc < -1e-6) {
                    RouteCandidate cand = new RouteCandidate(closed, closeTravel, closeService, rc);
