...
public class SolveGreedy {
    ...
    public static void main(String[] args) {
        File data = new File("src/core/data_all.txt");
        File travelTimesFile = new File("src/core/travel_times_collapsedv2.txt");
        ...
        try {
            HTMInstance allStops = Utils.readInstance("src/core/data_all.txt", cleaningIndicator, nightIndicator);
            ...
            try {
                ...
                double[][] travelTimes = Utils.readTravelTimes("src/core/travel_times_collapsedv2.txt");
